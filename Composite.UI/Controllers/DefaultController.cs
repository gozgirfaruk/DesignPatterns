using Composite.UI.CompositePattern;
using Composite.UI.DAL;
using Microsoft.AspNetCore.Mvc;
using Microsoft.EntityFrameworkCore;

namespace Composite.UI.Controllers
{
    public class DefaultController : Controller
    {
        private readonly CompositeContext _context;

        public DefaultController(CompositeContext context)
        {
            _context = context;
        }
